...
class Pipe():
    ...
    def V(self):
        ...
        '''
        self.vel= ((self.Q)/(self.A))*.001  # the average velocity is Q/A ( ( (L/s)/(m^2) )*(m^3/L) ) (for water)
        return self.vel
    ...
    def Re(self):
        ...
        :return:
        '''
        self.reynolds= ((self.V())*self.d)*(1000/.00089) # Re=rho*V*d/mu, be sure to use V() so velocity is updated.
    ...
    def frictionHeadLoss(self):  # calculate headloss through a section of pipe in m of fluid
        ...
        #use D-W equation for pressure head f*(L/D)*(V^2/2g)
